...
### Улучшено
- Новый современный дизайн HTML-отчета УРВ: мягкие цвета, градиенты, улучшенные отступы, адаптивность
- SVG-иконки для статистики и событий (вход/выход, ночная смена, нет выхода)
- Подвал с названием системы и временем генерации отчета
- Исправлено выравнивание колонки "Событие" при наличии метки +1 (ночная смена)
- Полное имя сотрудника теперь везде отображается корректно
- Много мелких улучшений визуала и структуры шаблона
